...
FlowRouter.route('/aboutBusiness/:businessLink', {
    ...
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('oneBusinessVideo',params.businessLink),
                    ...
                    Meteor.subscribe('oneBusinessImages',params.businessLink),
...
FlowRouter.route('/bannerInvoice/:businessLink/:paymentId', {
...
FlowRouter.route('/adsInvoice/:businessLink/:paymentId', {
