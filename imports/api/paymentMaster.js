...
// 		}else{
// 			var quickWalletUrl = 'https://app.quikwallet.com';
// 			var METEOR_URL = current;
// 		}

// 		consoe.log(METEOR_URL);
	...
	'updateInvoiceforOnlinePayment':function(businessLink, invoiceNumber,current){
		...
		if(receiptObj.totalAmount){
			...
			var quickWalletInput 	= {
				...
				"amount"   		:   grandTotal,
				"udf1"			: 	receiptObj._id,
				"redirecturl" 	: 	'https://'+METEOR_URL+'/payment-response?orderId='+receiptObj._id+"&InvNo="+receiptObj.invoiceNumber+"&BusLink="+receiptObj.businessLink,
			};
